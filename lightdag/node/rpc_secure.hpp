...
{
/**
 * Specialization of lightdag::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_service & service_a, lightdag::node & node_a, lightdag::rpc_config const & config_a);
...
/**
 * Specialization of lightdag::rpc_connection for establishing TLS connections.
 * Handshakes with client certificates are supported.
 */
class rpc_connection_secure : public rpc_connection
{
public:
	rpc_connection_secure (lightdag::node &, lightdag::rpc_secure &);
